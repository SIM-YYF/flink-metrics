...
public class JobDemo3_7 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_7.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_7.class.getSimpleName();
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "flow_sensor_healthy_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "flow_sensor_healthy_result"));
