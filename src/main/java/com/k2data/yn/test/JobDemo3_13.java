...
public class JobDemo3_13 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_13.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_13.class.getSimpleName();
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "flow_less_than_60standard_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "flow_less_than_60standard_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("flow_less_than_60standard_result", "bool", outputStorage1));
