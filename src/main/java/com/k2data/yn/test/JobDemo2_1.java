...
public class JobDemo2_1 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo2_1.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = "modelId_deviceId_operatorId_1001";
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_001");

        String operatorName = "double_var_healthy";
        ...
        kwargs.put("var1_low_cut", 8180);
        kwargs.put("var1_high_cut", 8200);
        kwargs.put("var2_low_cut", 499);
        kwargs.put("var2_high_cut", 501);
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", "modelId_deviceId_operatorId_1001_result", "running_healthy_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_001_result", "running_healthy_result"));
