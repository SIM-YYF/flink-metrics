...
public class JobDemo3_1 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_1.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_1.class.getSimpleName();
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_11001");

        String operatorName = "feature_var_standard_recently";
        ...
        kwargs.put("time_window", 30);
        kwargs.put("var_standard_recently", 0.43);
        kwargs.put("range_upper_threshold", 0.03);
        kwargs.put("mean_lower_threshold", 0.21);
        kwargs.put("mean_upper_threshold", 0.5);
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "var_standard_recently"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "var_standard_recently"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("var_standard_recently", "double", outputStorage1));
        ...
        if ("kafka".equalsIgnoreCase(inputType)) {
            ...
            consumerProperties1.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, "client123");
        ...
        inputStream1.addSink(new InfluxdbSinker("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result", "device_11001", jobName));
