...
public class JobDemo3_9 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_9.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_9.class.getSimpleName();
        ...
        storage1.put(inputType, new KafkaStorage("10.1.10.21:9092", "JobDemo3_4", "flow_gradient"));
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "flow_decrease_vastly_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "flow_decrease_vastly_result"));
