...
public class JobDemo3_3 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_3.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_3.class.getSimpleName();
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_11001");

        String operatorName = "feature_var_gradient";
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "pressure_gradient"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "pressure_gradient"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("pressure_gradient", "double", outputStorage1));
