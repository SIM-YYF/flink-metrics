...
public class JobDemo3_10 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_10.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_10.class.getSimpleName();
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "pressure_greater_than_80standard_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "pressure_greater_than_80standard_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("pressure_greater_than_80standard_result", "bool", outputStorage1));
