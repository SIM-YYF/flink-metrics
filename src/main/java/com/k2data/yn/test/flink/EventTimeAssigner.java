...
public class EventTimeAssigner implements AssignerWithPeriodicWatermarks<PointData> {
    ...
    @Override
    public long extractTimestamp(PointData pointData, long l) {
        long timestamp = pointData.getTimestamp();
