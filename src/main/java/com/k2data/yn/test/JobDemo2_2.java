...
public class JobDemo2_2 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo2_2.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = "modelId_deviceId_operatorId_1002";
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_001");

        String operatorName = "sensor_healthy";
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", "modelId_deviceId_operatorId_1002_result", "pressure_sensor_healthy_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_001_result", "pressure_sensor_healthy_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("pressure_sensor_healthy_result", "bool", outputStorage1));
...
//                            long timestamp = value.get(value.size() - 1).get(0).getTimestamp();   //这里取每组数据的最小时间戳作为此次rpc计算结果的时间戳
