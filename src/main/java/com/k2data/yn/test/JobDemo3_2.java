...
public class JobDemo3_2 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_2.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_2.class.getSimpleName();
        ...
        kwargs.put("var_standard_recently", 326.5);
        kwargs.put("range_upper_threshold", 50);
        kwargs.put("mean_lower_threshold", 250);
        kwargs.put("mean_upper_threshold", 400);
