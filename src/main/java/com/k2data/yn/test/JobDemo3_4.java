...
public class JobDemo3_4 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_4.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_4.class.getSimpleName();
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "flow_gradient"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "flow_gradient"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("flow_gradient", "double", outputStorage1));
