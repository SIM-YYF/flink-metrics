...
public class JobDemo3_8 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_8.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_8.class.getSimpleName();
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_11001");

        String operatorName = "omen_var_less_than_lower_threshold";
        ...
        kwargs.put("var_lower_threshold", -0.01);

        String inputType = "kafka";
        List<InputParam> inputParams = new LinkedList<>();
        Map<String, Storage> storage1 = new HashMap<>();
        storage1.put(inputType, new KafkaStorage("10.1.10.21:9092", "JobDemo3_3", "pressure_gradient"));
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "pressure_decrease_vastly_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "pressure_decrease_vastly_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("pressure_decrease_vastly_result", "bool", outputStorage1));
