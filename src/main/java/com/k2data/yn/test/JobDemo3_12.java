...
public class JobDemo3_12 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_12.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_12.class.getSimpleName();
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_11001");

        String operatorName = "omen_var_less_than_proportional_standard";
        ...
        storage2.put(inputType, new KafkaStorage("10.1.10.21:9092", "JobDemo3_1", "var_standard_recently"));
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "pressure_less_than_50standard_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "pressure_less_than_50standard_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("pressure_less_than_50standard_result", "bool", outputStorage1));
