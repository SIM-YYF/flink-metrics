...
public class JobDemo2_3 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo2_3.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = "modelId_deviceId_operatorId_1003";
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", "modelId_deviceId_operatorId_1003_result", "flow_sensor_healthy_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_001_result", "flow_sensor_healthy_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("flow_sensor_healthy_result", "bool", outputStorage1));
