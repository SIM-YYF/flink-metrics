...
public class JobDemo3_5 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo3_5.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = JobDemo3_5.class.getSimpleName();
        Map<String, String> tags = new HashMap<>();
        tags.put("deviceId", "device_11001");

        String operatorName = "omen_double_var_healthy";
        ...
        kwargs.put("var1_lower_threshold", 8180);
        kwargs.put("var1_upper_threshold", 8200);
        kwargs.put("var2_lower_threshold", 499);
        kwargs.put("var2_upper_threshold", 501);

        String inputType = "kafka";
        List<InputParam> inputParams = new LinkedList<>();
        Map<String, Storage> storage1 = new HashMap<>();
        storage1.put(inputType, new KafkaStorage("10.1.10.21:9092", "esf-wenfei", "load_tonnage"));
        inputParams.add(new InputParam("var1", "double", 1000, false, storage1));
        Map<String, Storage> storage2 = new HashMap<>();
        storage2.put(inputType, new KafkaStorage("10.1.10.21:9092", "esf-wenfei", "AC5000PZD_in3"));
        inputParams.add(new InputParam("var2", "double", 1000, false, storage2));


        String outputType = "kafka";
        Map<String, Storage> outputStorage1 = new HashMap<>();
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", jobName, "running_healthy_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_11001_result_yntest", "running_healthy_result"));
        List<OutputParam> outputParams = new LinkedList<>();
        outputParams.add(new OutputParam("running_healthy_result", "bool", outputStorage1));
