...
public class JobDemo2_4 {

    private final static Logger LOGGER = LoggerFactory.getLogger(JobDemo2_4.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 控制参数
        String jobName = "modelId_deviceId_operatorId_1004";
        ...
        kwargs.put("time_window", (int) windowSize);  //todo: long类型的值无法传递给rpc
        kwargs.put("var_gradient_cut", -0.01);
        ...
        outputStorage1.put(outputType, new KafkaStorage("10.1.10.21:9092", "modelId_deviceId_operatorId_1004_result", "pressure_decrease_vastly_result"));
        outputStorage1.put("influxdb", new InfluxdbStorage("http://10.1.10.21:8086", "k2data", "K2data1234", "esf", "device_001_result", "pressure_decrease_vastly_result"));
